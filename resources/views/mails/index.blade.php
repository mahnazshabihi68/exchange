...
<body itemscope itemtype="http://schema.org/EmailMessage"
      style=" box-sizing: border-box; font-size: 14px; -webkit-font-smoothing: antialiased; -webkit-text-size-adjust: none; width: 100% !important; height: 100%; line-height: 1.6em; background-color: #f6f6f6; margin: 0;"
      bgcolor="#f6f6f6">
    ...
    <tr style=" box-sizing: border-box; font-size: 14px; margin: 0;">
        ...
        <td class="container" width="600"
            ...
            <div class="content"
                ...
                <table class="main" width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr style=" box-sizing: border-box; font-size: 14px; margin: 0;">
                        <td class="alert alert-warning"
                            style="box-sizing: border-box; font-size: 16px; vertical-align: top; color: #fff; font-weight: 500; text-align: center; border-radius: 3px 3px 0 0; background-color: #71b6f9; margin: 0; padding: 20px;"
                    ...
                    <tr style=" box-sizing: border-box; font-size: 14px; margin: 0;">
                        <td class="content-wrap"
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr style=" box-sizing: border-box; font-size: 14px; margin-top: 20px">
                                    <td align="center" class="content-block"
                                        style=" box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px; text-align: center"
                                        valign="top">
                                        {!! $body !!}
                                    </td>
                                </tr>
                ...
                <div class="footer"
                     style=" box-sizing: border-box; font-size: 14px; width: 100%; clear: both; color: #999; margin: 0; padding: 20px;">
                    <table width="100%"
                           style=" box-sizing: border-box; font-size: 14px; margin: 0;">
                        <tr style=" box-sizing: border-box; font-size: 14px; margin: 0;">
                            <td class="aligncenter content-block"
                                style=" box-sizing: border-box; font-size: 12px; vertical-align: top; color: #999; text-align: center; margin: 0; padding: 0 0 20px;"
                                align="center" valign="top"><p
                                    style=" box-sizing: border-box; font-size: 12px; color: #999;  margin: 0;"><a
                                        href="{{ config('app.url') }}"></a>{{ config('settings.name_'.app()->getLocale()) }}
                                </p>
                            </td>
                        </tr>
                    </table>
